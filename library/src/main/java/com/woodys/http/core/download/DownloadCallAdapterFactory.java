...
import com.woodys.http.scheduler.SynchronousExecutor;
import com.woodys.http.utils.AnnotationUtils;
...
public final class DownloadCallAdapterFactory extends CallAdapter.Factory {
    ...
    public CallAdapter<?, ?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
        ...
        final Executor executor = AnnotationUtils.isAnnotationPresent(annotations, SkipCallbackExecutor.class)
                ? null
        ...
        return new CallAdapter<ResponseBody, DownloadCall<?>>() {
            ...
            public DownloadCall<ResponseBody> adapt(retrofit2.Call<ResponseBody> call) {
                ...
                return new RealDownloadCall<>(SynchronousExecutor.get(), call);
            }
        };
    }
}
